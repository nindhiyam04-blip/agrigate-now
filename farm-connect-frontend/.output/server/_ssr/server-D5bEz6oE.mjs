...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-D5bEz6oE.js
var server_D5bEz6oE_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DMvZRF1I.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-bMbA0rfW.mjs").then((n) => n.t),
		import("./start-DtK8mrJ-.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_D5bEz6oE_exports as t };
