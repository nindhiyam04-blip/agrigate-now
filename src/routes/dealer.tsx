            ...
            <ol className="relative space-y-6 border-l-2 border-dashed pl-6">
              {[
                ...
                <li key={label as string} className="relative">
                  <span
                    className={`absolute -left-[31px] top-1 size-4 rounded-full border-2 ${done ? "gradient-primary border-transparent" : "bg-background"}`}
                  />
            ...
            {[
              {
                name: "Starter",
                price: "₹0",
                perks: ["10 listings/month", "Basic filters", "Email support"],
              },
              {
                name: "Growth",
                price: "₹1,499/mo",
                perks: ["Unlimited browsing", "Priority driver booking", "Escrow payments"],
                featured: true,
              },
              {
                name: "Enterprise",
                price: "₹4,999/mo",
                perks: ["Multi-buyer accounts", "Dedicated manager", "API & bulk export"],
              },
            ].map((p) => (
              <GlassCard
                key={p.name}
