...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Reach the AgriLink support desk by phone, email or the contact form." },
      { property: "og:title", content: "Contact AgriLink" },
      { property: "og:description", content: "Support in Tamil and English, 7 am to 9 pm." },
    ],
  }),
  component: () => (
    <ContentPage eyebrow="Contact us" title="We answer in Tamil and English" intro="Support desk open 7:00 am – 9:00 pm, all days.">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <Field label="Mobile"><Input className="rounded-xl" placeholder="+91 98400 00000" /></Field>
      </div>
      <Field label="Message"><Textarea className="min-h-32 rounded-xl" placeholder="How can we help?" /></Field>
      <Button className="rounded-full gradient-primary text-primary-foreground" onClick={() => toast.success("Message sent — we'll call you back")}>
        Send message
      </Button>
    </ContentPage>
  ),
