...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-Bv1igK_T.js
var server_Bv1igK_T_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D8FeNTC3.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-hH4uaiaK.mjs").then((n) => n.t),
		import("./start-D6nhG4xB.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_Bv1igK_T_exports as t };
